...
The question is, is this year any different? Is this really the final popping of the bubble? Or is the growth of Crypto better described by a [(hyper-sensitive) S-Curve of Technological Adoption, which is itself characterized by fractally repeating, exponentially increasing Gartner Hype Cycles](**The growth of adoption of Bitcoin and therefore bitcoin price is following an S-Curve of Technological Adoption, which is itself characterized by fractally repeating, exponentially increasing Gartner Hype Cycles.**)?
